...
function Header() {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full h-[12vh] bg-[#fffaf4] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] transition-transform duration-300 z-50 ${
    ...
    >
      <div className="max-w-7xl mx-auto gap-15 flex items-center justify-between h-full px-6 sm:px-12 md:px-20 lg:px-32 text-[13px] font-serif text-gray-700">
        ...
        <div className="flex-1 flex justify-center">
          <div
            className='bg-[url("/Saffronlogo.jpg")] h-[9vh] w-[120px] bg-no-repeat bg-contain bg-center cursor-pointer'
          ></div>
        </div>
        <div className="cursor-pointer hover:text-gray-500 hidden sm:flex items-center gap-1">
          <Phone size={16} />
